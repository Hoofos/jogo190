...
if( isset( $_POST['Incluir'] ) ) {
	...
	$maxId = $obj_connect->maxReg( 'id_opcao', 'fr_opcoes' ) ;
	$obj_connect->connect();
	...
	if ( mysql_num_rows( $q ) ) {
		while( $result = mysql_fetch_array( $q ) ) {
			...
			$insertSql = "INSERT INTO fr_indicadores_opcoes(id_indicador,id_opcao,nivel_indicador) VALUES(" . $result['id_indicador'] . "," . $maxId . "," . $nivel_indicador . ")" ;
